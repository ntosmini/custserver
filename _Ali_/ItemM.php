...
switch($ScrapType){
	case 'curl' :
		exec("python3 /home/ntosmini/public_html/_Ali_/ItemM.curl.py {$MConfigData}", $ResultArr);
	break;
	case 'uc' :
		exec("PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin python3 /home/ntosmini/public_html/_Ali_/ItemM.uc.py {$MConfigData}", $ResultArr);
	break;
	default :
		exec("python3 /home/ntosmini/public_html/_Ali_/ItemM.selenium.py {$MConfigData}", $ResultArr);
	break;
}
