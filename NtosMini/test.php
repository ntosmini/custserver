...
$SiteUrl = "http://ntos.co.kr";//(empty($_POST['SiteUrl']))?"not":$_POST['SiteUrl'];
$WebType = "Chrome";//(empty($_POST['WebType']))?"Chrome":$_POST['WebType'];	// "Chrome" or "Firefox" or "curl"
$Referer = "not";//(empty($_POST['Referer']))?"not":$_POST['Referer'];
$Agent = "not";//(empty($_POST['Agent']))?"not":$_POST['Agent'];
$Proxy = "not";//(empty($_POST['Proxy']))?"not":$_POST['Proxy'];
